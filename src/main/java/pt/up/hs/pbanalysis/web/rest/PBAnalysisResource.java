...
public class PBAnalysisResource {
    ...
    public ResponseEntity<PBAnalysisDTO> createPBAnalysis(@RequestBody PBAnalysisDTO pBAnalysisDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PBAnalysisDTO> updatePBAnalysis(@RequestBody PBAnalysisDTO pBAnalysisDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<PBAnalysisDTO>> getAllPBAnalyses(PBAnalysisCriteria criteria, Pageable pageable) {
    ...
    public ResponseEntity<Long> countPBAnalyses(PBAnalysisCriteria criteria) {
    ...
    public ResponseEntity<PBAnalysisDTO> getPBAnalysis(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deletePBAnalysis(@PathVariable Long id) {
